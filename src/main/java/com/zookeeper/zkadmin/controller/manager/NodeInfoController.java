...
public class NodeInfoController {
    ...
    public ResultObj cluster02(@RequestParam("clusterID") String clusterID, @RequestParam("nodePath") String nodePath) throws Exception {
        ...
        if (s != null) {
            ...
            nodeMeta.put(ZKAdminConstants.NODE_STAT_ACL_VERSION, String.valueOf(s.getAversion()));

            nodeMeta.put(ZKAdminConstants.NODE_STAT_C_TIME, s.getCtime());
            nodeMeta.put(ZKAdminConstants.NODE_STAT_M_TIME, s.getMtime());

            nodeMeta.put(ZKAdminConstants.NODE_STAT_C_VERSION, String.valueOf(s.getCversion()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_CZXID, String.valueOf(s.getCzxid()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_DATA_LENGTH, String.valueOf(s.getDataLength()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_EPHEMERAL_OWNER, String.valueOf(s.getEphemeralOwner()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_MZXID, String.valueOf(s.getMzxid()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_NUM_CHILDREN, String.valueOf(s.getNumChildren()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_PZXID, String.valueOf(s.getPzxid()));
            nodeMeta.put(ZKAdminConstants.NODE_STAT_DATA_VERSION, String.valueOf(s.getVersion()));
        }
